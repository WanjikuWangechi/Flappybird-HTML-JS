...
function create () {
    ...
    this.physics.add.overlap(bird, topColumns, ()=>hasBumpedtrue, true, null, this);
...
function update () {
    if(cursors.space.isDown && !isGameStarted) {
        isGameStarted = true;
        messageToPlayer.text = ('Instructions: Press the "^" button to stay upright And dont hit the columns or ground');
      }
